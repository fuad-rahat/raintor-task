...
export default function FooterSection() {
  return (
    <footer className="relative mx-auto max-w-[98vw] mt-16 mb-4  w-full rounded-3xl bg-black text-white px-6 py-12 flex flex-col items-center justify-center shadow-2xl" style={{minHeight: 400}}>
      {/* Top Row */}
      <div className="w-full flex flex-col md:flex-row items-center justify-between mb-8">
        ...
        <h2 className="font-sporting text-4xl md:text-6xl font-bold text-center flex-1">As you can</h2>
        <span className="hidden md:block w-32" />
      </div>
      {/* Columns */}
      <div className="w-full flex flex-col md:flex-row justify-center items-start gap-12 md:gap-24 mb-12">
        {/* Say hello & Call */}
      ...
      {/* Bottom Row */}
      <div className="w-full flex flex-col md:flex-row items-center justify-between mt-8 gap-4">
